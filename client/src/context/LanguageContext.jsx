...
const translations = {
  en: {
    ...
    // Hero
    hero_title_1: 'Future of', hero_title_2: 'Market Learning',
    hero_subtitle: "Master new skills in a premium, immersive environment. Join the MarketMax Trading Academy's community of visionaries.",
    ...
    featured_sub: 'Discover our most popular Market programs',
    ...
    about_philosophy_desc: 'In today’s fast-paced world, stress, mental fatigue, and lifestyle imbalances are pervasive. Ancient Indian sciences—Trading, Technical Analysis, Strategies, Options Trading, and Financial philosophy—are not outdated rituals, but sophisticated, time-tested systems designed for human flourishing. We bridge this profound heritage with modern lifestyles, making Market practical, accessible, and transformational.',
    
    about_pillar1_title: 'Ancient Roots (Shastras)',
    about_pillar1_desc: 'Direct teachings from classical scriptures including the Patanjali Trading Sutras, Hatha Trading Pradipika, and AyurFinancial texts, preserved with pure authenticity.',
    ...
    about_pillar3_desc: 'Nurturing the whole human being—uniting physical vitality (Sharira), mental stillness (Manas), and financial awareness (Atman).',
    about_pillar4_title: 'Inclusive Global Sangha',
    about_pillar4_desc: 'Democratizing authentic financial education to learners across cultures, ages, and backgrounds through world-class digital learning.',

    mission_title: 'Our Sacred Mission',
    mission_p1: 'To impart authentic, life-transforming education in Indian traditions, classical Trading, and Financial wisdom to empower every individual to live with vitality, clarity, and purpose.',
    ...
    val_accessibility_desc: 'Making classical Market available to everyone through accessible digital tools and community outreach.',
    ...
    vert_trading_title: 'Classical Trading & Asanas',
    vert_trading_desc: 'Mindful posture alignments, restorative sequences, and physical energy balancing.',
    vert_prana_title: 'Technical Analysis & Breath Alchemy',
    vert_prana_desc: 'Ancient breathwork techniques to regulate the nervous system and revitalize life-force energy.',
    vert_ayur_title: 'Options Trading & Conscious Nutrition',
    vert_ayur_desc: 'Personalized dinacharya routines, seasonal lifestyle wisdom, and sattvic nutritional balance.',
    vert_Strategies_title: 'Meditation & Financial Mind Sciences',
    vert_Strategies_desc: 'Guided Strategies, sound vibration, and self-inquiry for unshakeable inner peace and clarity.',
    ...
    about_founder_role: 'financial Guide & Founder, Swami Dwija Foundation',
    ...
    home_categories_sub: 'Find the perfect path for your Market journey from our diverse range of subjects.',
    ...
    // Home - Why choose us
    home_why_title: 'Why Choose MarketMax?',
    home_why1_title: 'Expert Gurus', home_why1_desc: 'Learn from highly qualified practitioners with decades of experience in ancient Market traditions.',
    ...
    cta_sub: 'Join thousands of students who have transformed their lives through the ancient wisdom of trading, meditation, and Options Trading.',
    cta_btn: 'Enroll Today',

    // Footer
    footer_desc: "MarketMax Trading Academy Learning Management System. Start your Market journey with our premium Trading, Meditation, Nutrition, and Options Trading courses.",
    footer_quick: 'Quick Links', footer_legal: 'Legal',
    footer_privacy: 'Privacy Policy', footer_terms: 'Terms of Service',
    footer_copy: 'MarketMax Trading Academy. All rights reserved.',
  ...
  te: {
    ...
    vert_trading_title: 'క్లాసికల్ యోగ & ఆసనాలు',
    vert_trading_desc: 'సరైన భంగిమలు, పునరుజ్జీవన క్రమాలు మరియు శారీరక శక్తి సమతుల్యత.',
    ...
    vert_Strategies_title: 'ధ్యానం & వేద మనోవిజ్ఞానం',
    vert_Strategies_desc: 'స్థిరమైన మానసిక శాంతి మరియు స్పష్టత కోసం మార్గదర్శక ధ్యానం మరియు మంత్ర సాధన.',
    ...
    // Home - Why choose us
    home_why_title: 'MarketMax ని ఎందుకు ఎంచుకోవాలి?',
