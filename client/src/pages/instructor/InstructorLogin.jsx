...
const InstructorLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center p-4 md:p-8 font-inter relative overflow-hidden">
      ...
      <div className="absolute -top-32 -left-32 w-[550px] h-[550px] bg-[#D4AF37]/12 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-5xl z-10">
        ...
        <div className="mb-6 flex justify-between items-center px-2">
          <Link 
            to="/"
            className="inline-flex items-center gap-2 text-xs font-bold text-gray-500 hover:text-[#D4AF37] transition-colors bg-[#1E293B]/80 backdrop-blur-md px-4 py-2 rounded-xl border border-gray-700/80 shadow-xs"
          >
            <FaArrowLeft size={11} /> Back to Main Academy
          </Link>
          <div className="flex items-center gap-2 text-[11px] font-bold text-[#D4AF37] bg-[#D4AF37]/10 px-3 py-1.5 rounded-full border border-[#D4AF37]/30/60">
            <FaSpa />
            Faculty & Guru Portal
          </div>
        </div>
        ...
        <motion.div 
          ...
          className="bg-[#1E293B]/80 backdrop-blur-2xl border border-white shadow-[0_20px_70px_rgba(0,0,0,0.06)] rounded-[2.5rem] overflow-hidden grid grid-cols-1 lg:grid-cols-12"
        >
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-[#06331A] via-[#0A4F2A] to-[#14532D] p-8 lg:p-12 text-white relative overflow-hidden flex flex-col justify-between">
            ...
            <div className="relative z-10 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#1E293B]/10 backdrop-blur-md border border-white/20 rounded-full text-[10px] font-extrabold tracking-widest uppercase text-[#D4AF37]">
                <FaOm /> Guru & Mentor Workspace
              </div>

              <div className="space-y-2">
                <div className="bg-[#1E293B] p-3 rounded-2xl inline-block shadow-md mb-2">
                ...
                <p className="text-xs text-emerald-100/80 font-medium">
                  MarketMax Trading Academy Trading & Market Academy
                </p>
              </div>

              <div className="pt-4 border-t border-white/10 space-y-3.5 text-xs text-emerald-50/90 font-medium">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#1E293B]/10 flex items-center justify-center text-[#D4AF37] shrink-0">
                    <FaVideo size={13} />
                  </div>
                  <span>Host & Stream Live Zoom Trading Sessions</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#1E293B]/10 flex items-center justify-center text-[#D4AF37] shrink-0">
          ...
          <div className="lg:col-span-7 p-8 lg:p-12 flex flex-col justify-center relative">
            ...
            <div className="mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#D4AF37]/10 text-[#D4AF37]-dark rounded-full text-xs font-bold uppercase tracking-wider mb-2">
                Faculty Access
              </div>
              <h1 className="text-2xl lg:text-3xl font-black text-white tracking-tight">Instructor Sign In</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-[#0F172A]/80 border border-gray-700 rounded-2xl text-sm font-medium text-white placeholder-gray-400 focus:bg-[#1E293B] focus:ring-2 focus:ring-[#0A4F2A]/20 focus:border-[#0A4F2A] outline-none transition-all shadow-xs"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-xs text-[#D4AF37] font-extrabold hover:underline cursor-pointer"
                  >
                    Forgot Password?
                  </button>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full pl-11 pr-12 py-3.5 bg-[#0F172A]/80 border border-gray-700 rounded-2xl text-sm font-medium text-white placeholder-gray-400 focus:bg-[#1E293B] focus:ring-2 focus:ring-[#0A4F2A]/20 focus:border-[#0A4F2A] outline-none transition-all shadow-xs"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#D4AF37] hover:bg-[#06331A] text-white font-extrabold py-4 rounded-2xl shadow-lg shadow-[#0A4F2A]/25 hover:shadow-[#0A4F2A]/40 transition-all duration-300 disabled:opacity-60 flex items-center justify-center gap-2 text-sm tracking-wide mt-2 cursor-pointer"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-8 pt-6 border-t border-gray-800 flex items-center justify-between text-[11px] text-gray-400 font-medium">
              <span>MarketMax Trading Academy Faculty Network</span>
              <Link to="/admin/login" className="text-gray-500 hover:text-[#D4AF37] font-bold">
                Admin Login ↗
              </Link>
            </div>
        ...
        {isForgotModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-[#1E293B] w-full max-w-md rounded-[2.5rem] p-6 lg:p-8 shadow-2xl z-10"
            >
              <div className="flex items-center justify-between pb-3 border-b border-gray-800 mb-5">
                ...
                <button
                  onClick={() => setIsForgotModalOpen(false)}
                  className="w-8 h-8 rounded-full bg-gray-800 hover:bg-gray-200 flex items-center justify-center text-gray-500 transition-all cursor-pointer"
                >
                  <FaTimes size={13} />
                </button>
              </div>
              ...
              {forgotMessage && forgotStep === 2 && (
                <div className="mb-4 p-3.5 bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#D4AF37] text-xs font-bold rounded-2xl flex items-center gap-2">
              ...
              {forgotStep === 1 && (
                <form onSubmit={handleSendResetOtp} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="instructor@marketmaxtrading.org"
                        className="w-full pl-11 pr-4 py-3 bg-[#0F172A] border border-gray-700 rounded-2xl text-sm font-medium focus:bg-[#1E293B] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] outline-none"
                      />
                    </div>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-[#D4AF37] hover:bg-[#D4AF37]-dark text-white font-extrabold text-xs rounded-2xl shadow-md disabled:opacity-60 transition-all flex justify-center items-center gap-2 cursor-pointer"
                  >
                    {forgotLoading ? (
                      <>
                        <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                ...
                <form onSubmit={handleResetInstructorPassword} className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      placeholder="123456"
                      className="w-full px-4 py-3 bg-[#0F172A] border border-gray-700 rounded-2xl text-center text-xl font-mono tracking-widest font-black text-[#D4AF37]-dark focus:bg-[#1E293B] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] outline-none"
                    />
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 bg-[#0F172A] border border-gray-700 rounded-2xl text-sm font-medium focus:bg-[#1E293B] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] outline-none pr-10"
                      />
                      <button
                        type="button"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#0F172A] border border-gray-700 rounded-2xl text-sm font-medium focus:bg-[#1E293B] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] outline-none"
                    />
                  </div>
              ...
              {forgotStep === 3 && (
                <div className="text-center space-y-4 py-4">
                  <div className="w-14 h-14 bg-[#D4AF37]/20 rounded-full flex items-center justify-center mx-auto text-[#D4AF37]">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-[#D4AF37] hover:bg-[#D4AF37]-dark text-white text-xs font-bold rounded-2xl shadow-md transition-all cursor-pointer"
                  >
