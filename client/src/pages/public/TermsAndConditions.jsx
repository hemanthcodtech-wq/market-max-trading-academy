      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          <p className="text-gray-500 text-sm md:text-base mt-2">
            Last Updated: August 20, 2026 • MarketMax Trading Academy (MarketMax)
          </p>
        ...
        >
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm">
              Welcome to <strong>MarketMax Trading Academy ("MarketMax", "we", "us", or "our")</strong>. By accessing our website (<a href="https://swamydwija.org" className="text-brand-green font-semibold underline">swamydwija.org</a>), registering an account, or enrolling in any live trading program, meditation course, or digital workshop, you acknowledge that you have read, understood, and agree to be bound by these Terms & Conditions.
            </p>
          </section>

          {/* 2. Educational & Market Disclaimer */}
          <section className="space-y-3">
            <h2 className="text-xl font-extrabold text-gray-900 flex items-center gap-2">
              <span className="w-7 h-7 rounded-xl bg-brand-green text-white text-xs flex items-center justify-center font-black">2</span>
              Health & Market Advisory Disclaimer
            </h2>
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-sm list-disc pl-5">
              ...
              <li>MarketMax Trading Academy reserves the right to revise curriculum fees or introduce promotional discounts without retroactive price adjustments for previous enrollments.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm">
              All proprietary video recordings, instructional curriculum, PDF guides, trademarks, and logos displayed on this platform are the intellectual property of MarketMax Trading Academy. Unauthorized recording, downloading, commercial re-distribution, or public broadcast of session materials is strictly prohibited and subject to legal action under the Indian Copyright Act, 1957.
            </p>
          </section>
