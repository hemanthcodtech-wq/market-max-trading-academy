      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        >
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm">
              MarketMax Trading Academy respects the privacy of our students and visitors. This Privacy Policy outlines how we collect, store, utilize, and protect personal data when you interact with our platform, mobile interfaces, and live learning services.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div className="p-4 bg-[#FAF7F2] rounded-2xl border border-gray-200/60 space-y-1.5">
                ...
                <p className="text-gray-600">Transaction ID, payment status, amount paid, and invoice details. (Card numbers/UPI PINs are never stored by MarketMax).</p>
              </div>
              <div className="p-4 bg-[#FAF7F2] rounded-2xl border border-gray-200/60 space-y-1.5">
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 bg-green-50/80 border border-green-200/80 rounded-2xl text-green-950 text-sm space-y-2">
              ...
              <p className="text-xs leading-relaxed text-green-800">
                Payment transactions on MarketMax Trading Academy are processed via certified, PCI-DSS compliant third-party payment gateways (including Razorpay / UPI / Net Banking). Sensitive payment credentials (such as CVV or banking passwords) are never transmitted to or retained on our application servers.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-sm list-disc pl-5">
              <li>To provide instant dashboard access to your enrolled trading batches and course materials.</li>
          ...
          <div className="pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gray-50/80 p-6 rounded-2xl">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">MarketMax Trading Academy, Telangana, India</p>
