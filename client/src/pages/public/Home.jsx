...
const Home = () => {
  ...
  return (
    <div className="bg-[#0B0F19] overflow-x-hidden text-gray-300 font-inter relative">
      ...
      {/* ─────────────────────────────────────────────────────────────
          SECTION 6.5: STUDENT VERIFIED TRANSFORMATIONS (HOVER P&L EFFECT)
      ───────────────────────────────────────────────────────────── */}
      <section className="py-20 bg-[#0B0F19] border-t border-gray-800 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-xs font-bold mb-3">
              <FaStar className="text-[#D4AF37]" /> Verified Trading Results
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-white font-outfit">
              REAL TRADERS. VERIFIED RESULTS.
            </h2>
            <p className="text-gray-400 text-sm md:text-base mt-3">
              See how our students transitioned from chaotic gambling to disciplined, rule-based execution.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              {
                name: 'Rahul Sharma',
                role: 'IT Professional & Part-Time Index Trader',
                pnl: '+₹1,84,500',
                broker: 'Zerodha Verified',
                strategy: 'SMC Demand Block Retest',
                quote: 'I used to blow up capital taking random tips. Learning the 1% risk math and waiting for institutional order blocks gave me back control.',
                badge: 'NIFTY INTRADAY',
                previewImg: '/images/setup_orderblock.jpg'
              },
              {
                name: 'Sneha Reddy',
                role: 'Swing Trader & Portfolio Builder',
                pnl: '+₹3,20,000',
                broker: 'Dhan Verified',
                strategy: 'Stage 2 Expansion & VCP',
                quote: 'MarketMax taught me how to sit on winning positions without getting scared out of high-conviction swing setups in large-cap equities.',
                badge: 'SWING EQUITIES',
                previewImg: '/images/setup_smc_fvg.jpg'
              },
              {
                name: 'Amit Kulkarni',
                role: 'Options Expiry Scalper',
                pnl: '+₹92,400',
                broker: 'Groww Verified',
                strategy: 'Zero-Hero Gamma Scalp',
                quote: 'Trading alongside the mentor on live floor from 1:30 PM to 2:45 PM on expiry day. Clear stop invalidation, no emotional revenge trades.',
                badge: 'OPTIONS BUYING',
                previewImg: '/images/setup_options_scalp.jpg'
              }
            ].map((trader, tIdx) => (
              <motion.div
                key={tIdx}
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: tIdx * 0.15 }}
                className="group relative bg-gradient-to-b from-[#131722] to-[#0D111A] rounded-2xl border border-gray-800 hover:border-emerald-500/40 p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_10px_30px_rgba(16,185,129,0.1)] overflow-hidden"
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[11px] font-bold text-gray-400 flex items-center gap-1">
                      <FaCheckCircle className="text-emerald-400 text-xs" /> {trader.broker}
                    </span>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="text-3xl font-black text-emerald-400 font-mono tracking-tight flex items-baseline gap-2">
                      {trader.pnl}
                      <span className="text-xs text-emerald-400/80 font-bold font-inter uppercase">Net Profit</span>
                    </div>
                  ...
                  <p className="text-xs text-gray-300 italic leading-relaxed mb-5">
                    "{trader.quote}"
                  </p>

                  {/* Hover Picture Preview of Trade Blueprint */}
                  <div className="relative w-full h-28 rounded-xl overflow-hidden bg-black/60 border border-gray-800 group-hover:border-emerald-500/30 mb-4 transition-all">
                    <img
                      src={trader.previewImg}
                      alt={trader.strategy}
                    ...
                    <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between text-[10px]">
                      <span className="text-gray-300 font-bold bg-black/70 px-2 py-0.5 rounded backdrop-blur-md">
                        Setup Chart Log
                      </span>
                      <span className="text-emerald-400 font-bold bg-black/70 px-2 py-0.5 rounded backdrop-blur-md flex items-center gap-1">
                        <FaEye /> Hovered
                      </span>
                    </div>
                  </div>
                ...
                <div className="pt-4 border-t border-gray-800/80 flex items-center justify-between">
                  <div>
                    ...
                    <span className="text-[11px] text-gray-400">{trader.role}</span>
                  </div>
                  <div className="w-8 h-8 rounded-full bg-[#D4AF37]/10 text-[#D4AF37] border border-[#D4AF37]/30 flex items-center justify-center text-xs font-bold font-outfit">
