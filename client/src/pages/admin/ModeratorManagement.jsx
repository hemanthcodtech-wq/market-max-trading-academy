    ...
    <div className="space-y-8 pb-24 md:pb-8 font-inter">
      ...
      <div className="bg-white/60 backdrop-blur-2xl rounded-[2.5rem] p-6 lg:p-8 border border-white/80 shadow-[0_8px_32px_rgba(0,0,0,0.03)] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl lg:text-3xl font-black text-slate-800 tracking-tight">Moderator Management</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-white/80 shadow-xs flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-blue-600/10 text-blue-600-dark flex items-center justify-center text-xl font-black">
            <FaUserShield />
          </div>
          <div>
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Total Moderators</span>
            <h3 className="text-2xl font-black text-slate-800">{moderators.length}</h3>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-white/80 shadow-xs flex items-center gap-4">
          ...
          <div>
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Portal Role</span>
            <h3 className="text-lg font-black text-slate-800">Platform Governance</h3>
          </div>
        </div>
      </div>
                  ...
                  <tr key={mod._id} className="hover:bg-white/90 transition-colors">
                    <td className="p-5 pl-8">
                      <div className="flex items-center gap-3.5">
                        ...
                        <div>
                          <div className="font-bold text-slate-800 text-sm">{mod.name || 'Unnamed Moderator'}</div>
                    ...
                    <td className="p-5">
                      <span className="px-3 py-1 bg-blue-600/10 text-blue-600 border border-blue-600/30/80 rounded-full text-xs font-bold uppercase tracking-wider">
                        Moderator
                      </span>
                    </td>
                    ...
                    <div className="col-span-full bg-white/50 backdrop-blur-md border border-white/60 p-5 rounded-2xl shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)] space-y-3">
                      <div className="flex justify-between items-center">
                        <label className="text-sm font-bold text-slate-700 flex items-center gap-2">
                          <FaLock className="text-blue-600" /> Portal Password
                        </label>
                        <button
                          type="button"
