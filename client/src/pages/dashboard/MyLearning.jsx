          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`${colors} px-5 py-3 flex justify-between items-center border-b border-white/50`}>
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-wide opacity-80 flex items-center gap-1 bg-[#1E293B]/30 px-2 py-0.5 rounded-full">
                          Enrolled
                        </span>
                      </div>
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        <div className="flex items-start gap-4 mb-4">
                          <div className="w-14 h-14 rounded-xl bg-[#0F172A] shrink-0 overflow-hidden border border-gray-800 flex items-center justify-center">
                          ...
                          <div className="flex-1 min-w-0 pt-1">
                            <h3 className="text-lg font-black text-gray-100 leading-snug line-clamp-2">{course.title}</h3>
                          </div>
                        </div>
                ...
                {courses.length === 0 && (
                  <div className="col-span-full text-center p-12 bg-[#1E293B] rounded-2xl border border-dashed border-gray-600 text-gray-500 font-medium">
