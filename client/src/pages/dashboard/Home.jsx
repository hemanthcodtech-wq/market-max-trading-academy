      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {stats.map((stat, i) => (
            <motion.div 
              ...
              key={i} 
              className="bg-[#1E293B] rounded-2xl p-6 border border-gray-800 shadow-sm flex items-center gap-4"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#2D2D2D] w-full h-full">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#1E293B]/5 rounded-full -mr-20 -mt-20 blur-3xl"></div>
              ...
              <div className="absolute inset-0 z-20 p-8 md:p-10 flex flex-col justify-center text-left">
                <div className="inline-flex items-center gap-2 bg-[#1E293B]/20 backdrop-blur-md px-3 py-1 rounded-full w-max mb-4 border border-white/10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white max-w-lg leading-tight mb-2">
                  {upcomingClass ? (upcomingClass.title || upcomingClass.course?.title || 'Live Class Session') : 'Welcome to MarketMax Learning'}
                </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#1E293B] rounded-3xl p-6 border border-gray-800 shadow-sm">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-lg font-bold text-white">Resume Learning</h3>
              </div>

              <div className="group cursor-pointer">
                <div className="w-full h-32 rounded-xl bg-gray-800 overflow-hidden mb-4 relative">
                  ...
                  <div className="absolute inset-0 z-20 flex items-center justify-center">
                    <div className="w-10 h-10 bg-[#1E293B]/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform">
                      <FaPlay className="text-[#C08552] ml-1" size={14}/>
                    </div>
                  </div>
                </div>
                <h4 className="font-bold text-gray-100 text-base leading-tight mb-1 group-hover:text-[#C08552] transition-colors">Mindfulness Fundamentals</h4>
            ...
            <div className="bg-[#1E293B] rounded-3xl p-6 border border-gray-800 shadow-sm">
              ...
              <div className="space-y-3">
                <button onClick={() => navigate('/dashboard/learning')} className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-[#0F172A] transition-colors group border border-transparent hover:border-gray-800">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[#C08552]/10 flex items-center justify-center text-[#C08552]">
                      <FaBookOpen size={16}/>
                    </div>
                    <span className="font-semibold text-gray-300 group-hover:text-[#C08552] transition-colors">My Courses</span>
                  </div>
                  <FaChevronRight className="text-gray-400 group-hover:text-[#C08552] text-xs"/>
                </button>
                
                <button onClick={() => navigate('/dashboard/profile')} className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-[#0F172A] transition-colors group border border-transparent hover:border-gray-800">
                  <div className="flex items-center gap-3">
                  ...
                  <FaChevronRight className="text-gray-400 group-hover:text-gray-400 text-xs"/>
                </button>
              </div>
            </div>
