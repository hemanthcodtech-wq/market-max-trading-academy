          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-3">
              <div className="flex flex-wrap items-center gap-2">
                <span className="px-3.5 py-1 rounded-full bg-[#1E293B]/15 backdrop-blur-md border border-white/20 text-emerald-200 text-xs font-black tracking-wider uppercase">
                  {course.category}
                </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:sticky lg:top-24 space-y-4">
            ...
            <div className="space-y-2.5">
              ...
              >
                <span className="text-sm font-extrabold flex items-center gap-2.5">
                  <FaBookOpen size={14} className={courseActiveTab === 'materials' ? 'text-white' : 'text-[#D4AF37]'} />
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {courseActiveTab === 'classes' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between pb-2">
                  <h2 className="text-lg font-black text-white">Class Schedule & Zoom Supervise Access</h2>
                        ...
                        >
                          ...
                          <div className="pt-3 border-t border-gray-800 mt-auto flex items-center justify-between">
                            {cls.zoomLink ? (
                              ...
                              <span className="w-full py-2 bg-gray-800 text-gray-400 rounded-xl font-bold text-xs text-center">
                                Session Configured
                              </span>
                            )}
                          </div>
            ...
            {courseActiveTab === 'materials' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between pb-2">
                  <div>
                    <h2 className="text-lg font-black text-white">Study Materials & Video Recordings</h2>
    ...
    <div className="space-y-8 pb-16 font-inter">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-[#06331A] via-[#0A4F2A] to-[#14532D] rounded-[2.5rem] p-6 lg:p-10 text-white shadow-[0_15px_40px_rgba(10,79,42,0.18)]">
        ...
        <div className="relative z-10 space-y-2">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#1E293B]/10 backdrop-blur-md border border-white/20 text-emerald-200 text-xs font-black tracking-wider uppercase">
          ...
          <p className="text-emerald-100/90 text-sm max-w-xl">
            Complete course access, live classroom monitoring, timetable oversight, and learner governance across MarketMax Trading Academy.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#1E293B]/80 backdrop-blur-xl p-5 rounded-3xl border border-white/80 shadow-xs flex items-center gap-4">
          <div className="w-13 h-13 rounded-2xl bg-[#D4AF37]/10 text-[#D4AF37]-dark flex items-center justify-center text-2xl font-black shrink-0">
            <FaBookOpen />
          </div>
          <div>
            <span className="text-xs font-bold text-gray-400 uppercase tracking-wider block">Assigned Programs</span>
            <h3 className="text-2xl font-black text-white">{stats.assignedCoursesCount || assignedCourses.length}</h3>
          </div>
        </div>
        ...
        <div className="bg-[#1E293B]/80 backdrop-blur-xl p-5 rounded-3xl border border-white/80 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-black text-white">{stats.totalInstructors || 0}</h3>
          </div>
        </div>
        ...
        <div className="bg-[#1E293B]/80 backdrop-blur-xl p-5 rounded-3xl border border-white/80 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-sm font-black text-[#D4AF37]">100% Safe & Serene</h3>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-1">
          <div>
            <h2 className="text-xl font-black text-white flex items-center gap-2">
              <FaGraduationCap className="text-[#D4AF37]" /> Courses Under Your Oversight (Complete Access)
            </h2>
        ...
        {loading ? (
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                    <div>
                      ...
                      <div className="p-2.5 rounded-xl bg-[#D4AF37]/10/90 border border-[#D4AF37]/30/80 flex items-center justify-between text-xs mb-3">
                        <div className="flex items-center gap-2 min-w-0">
                          <FaChalkboardTeacher className="text-[#D4AF37] shrink-0" size={13} />
                          <div className="min-w-0">
                            ...
                            {course.instructorId?.speciality && (
                              <span className="text-[10px] text-[#D4AF37] truncate block">
                                {course.instructorId.speciality}
                              </span>
                            )}
                          </div>
                      ...
                      {/* Course Metrics Grid */}
                      <div className="grid grid-cols-2 gap-2 text-xs bg-[#0B0F19] p-3 rounded-2xl border border-gray-700/60">
                        <div>
                          <span className="text-[10px] font-bold text-gray-400 uppercase block">Enrolled Students</span>
                          <span className="font-black text-white">{course.enrolledStudentsCount || 0} Learners</span>
                        </div>
                        <div>
          ...
          <div className="p-12 text-center bg-[#1E293B]/60 rounded-3xl border border-dashed border-gray-600 space-y-2">
            ...
            <h3 className="font-bold text-gray-300 text-sm">No courses currently assigned for moderation.</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="flex items-center justify-between pb-2 border-b border-gray-800">
              <div>
                <h2 className="text-lg font-black text-white flex items-center gap-2">
                  <FaVideo className="text-[#D4AF37]" /> Live Classrooms for Moderation
                </h2>
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="bg-[#1E293B]/80 backdrop-blur-2xl rounded-[2.5rem] p-6 border border-white/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] space-y-4">
            <h3 className="font-black text-sm text-white flex items-center gap-2">
              <FaShieldAlt className="text-[#D4AF37]" /> Moderation Protocols
            </h3>
            
            <div className="space-y-2.5 text-xs text-gray-400">
              <div className="p-3 bg-[#D4AF37]/10/60 rounded-2xl border border-[#D4AF37]/20/80 flex items-start gap-2.5">
                <FaCheckCircle className="text-[#D4AF37] shrink-0 mt-0.5" />
                <span>Ensure live Zoom session chat adheres to financial, yogic & respectful discourse.</span>
              </div>
              <div className="p-3 bg-[#D4AF37]/10/60 rounded-2xl border border-[#D4AF37]/20/80 flex items-start gap-2.5">
                <FaCheckCircle className="text-[#D4AF37] shrink-0 mt-0.5" />
            ...
            <div className="pt-4 border-t border-gray-800 text-xs text-gray-500 space-y-1.5">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono font-bold text-gray-100">{profile.emailOrPhone}</span>
              </div>
              <div className="flex justify-between">
                <span>Role:</span>
                <span className="font-bold text-[#D4AF37]-dark uppercase">Certified Moderator</span>
              </div>
            </div>
          </div>
        </div>
