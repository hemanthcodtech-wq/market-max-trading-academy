    ...
    <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center p-4 md:p-8 font-inter relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl z-10">
        ...
        <div className="mb-6 flex justify-between items-center px-2">
          ...
          <div className="flex items-center gap-2 text-[11px] font-bold text-[#D4AF37]-dark bg-[#D4AF37]/10 px-3 py-1.5 rounded-full border border-[#D4AF37]/20">
            <FaShieldAlt />
            Governance Portal
          </div>
        </div>
        ...
        >
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-[#06331A] via-[#0A4F2A] to-[#14532D] p-8 lg:p-12 text-white relative overflow-hidden flex flex-col justify-between">
            <div className="relative z-10 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#1E293B]/10 backdrop-blur-md border border-white/20 rounded-full text-[10px] font-extrabold tracking-widest uppercase text-emerald-200">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-emerald-100/80 font-medium">
                  MarketMax Trading Academy Community Governance
                </p>
              </div>

              <div className="pt-4 border-t border-white/10 space-y-3 text-xs text-emerald-50/90 font-medium">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#1E293B]/10 flex items-center justify-center text-emerald-200 shrink-0">
            ...
            <div className="relative z-10 pt-8 mt-8 border-t border-white/10 flex items-center justify-between text-[11px] text-emerald-200/70">
              ...
              <span>MarketMax Trust & Safety</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 p-8 lg:p-12 flex flex-col justify-center relative">
            ...
            <div className="mb-8">
              ...
              <h1 className="text-2xl lg:text-3xl font-black text-white tracking-tight">Moderator Sign In</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder="moderator@marketmaxtrading.org"
                    className="w-full pl-11 pr-4 py-3.5 bg-[#0F172A]/80 border border-gray-700 rounded-2xl text-sm font-medium text-white placeholder-gray-400 focus:bg-[#1E293B] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full pl-11 pr-12 py-3.5 bg-[#0F172A]/80 border border-gray-700 rounded-2xl text-sm font-medium text-white placeholder-gray-400 focus:bg-[#1E293B] focus:ring-2 focus:ring-[#D4AF37]/20 focus:border-[#D4AF37] outline-none transition-all"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-400 cursor-pointer"
                  >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#D4AF37] hover:bg-[#D4AF37]-dark text-white font-extrabold py-4 rounded-2xl shadow-lg shadow-brand-green/25 transition-all duration-300 disabled:opacity-60 flex items-center justify-center gap-2 text-sm cursor-pointer mt-2"
              >
                {isLoading ? (
                  <>
