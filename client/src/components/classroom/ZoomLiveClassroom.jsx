            ...
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-neutral-400 truncate">
                  {course?.title || 'MarketMax Trading Academy'} • Session ID: {meetingId}
                </p>
              </div>
            </div>
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-center space-y-6 max-w-xl mx-auto">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs sm:text-sm text-neutral-400 max-w-md mx-auto">
                    {course?.title || 'MarketMax Trading Academy'} • Scheduled Duration: {liveClass.durationMinutes || 60} mins
                  </p>
                </div>
